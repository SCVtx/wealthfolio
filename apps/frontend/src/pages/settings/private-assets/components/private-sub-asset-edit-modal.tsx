...
export function PrivateSubAssetEditModal({
  ...
  const { createPrivateSubAssetMutation, updatePrivateSubAssetMutation } = usePrivateAssetMutations();
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            <DialogHeader>
              ...
              <DialogDescription>
                Sub-assets are optional one-level look-through detail only. They do not roll into totals in v1.
              </DialogDescription>
            </DialogHeader>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      <ResponsiveSelect
                        ...
                        options={privateSubAssetReportingBasisOptions as unknown as ResponsiveSelectOption[]}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="md:col-span-2">
                    ...
                    <FormControl>
                      <Textarea rows={4} placeholder="Optional notes about this sub-asset" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
