      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-[560px]">
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            <DialogHeader>
              <DialogTitle>{fundManager?.id ? "Edit Fund Manager" : "Add Fund Manager"}</DialogTitle>
              <DialogDescription>
                Keep manager records first-class so private assets can select them instead of storing free-form labels.
              </DialogDescription>
            </DialogHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Textarea rows={4} placeholder="Optional context about this manager" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
