...
function getFormValues(asset: PrivateAsset | null | undefined, baseCurrency: string): PrivateAssetFormValues {
  return {
    name: asset?.name ?? "",
    isDirectInvestment: asset?.vehicleKind === "DIRECT",
    fundManagerId: asset?.fundManagerId ?? "",
    vehicleKind:
      asset?.vehicleKind && asset.vehicleKind !== "DIRECT" ? asset.vehicleKind : "FUND",
          ...
          <Form {...form}>
            <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
              <DialogHeader>
                ...
                <DialogDescription>
                  Capture the real owned vehicle, not a public-market stand-in. The latest update gets added separately from the detail page.
                </DialogDescription>
              </DialogHeader>
                    ...
                    <FormItem className="md:col-span-2">
                      <div className="flex items-start gap-3 rounded-md border p-3">
                        ...
                        <div className="space-y-1">
                          ...
                          <FormDescription>
                            Use this when the vehicle should not point at a fund manager. Direct assets save with `vehicle_kind = DIRECT`.
                          </FormDescription>
                        </div>
                      </div>
                      <FormMessage />
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <ResponsiveSelect
                          value={field.value}
                          onValueChange={field.onChange}
                          options={privateAssetVehicleKindOptions as unknown as ResponsiveSelectOption[]}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Private assets use the portfolio base currency in v1. Multi-currency
                        private assets are intentionally out of scope for this slice.
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormDescription>Leave blank when commitment is not part of the current v1 record.</FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem className="md:col-span-2">
                      ...
                      <FormControl>
                        <Textarea rows={4} placeholder="Optional notes about the asset" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
