...
vi.mock("@wealthfolio/ui/components/ui/badge", () => ({
  Badge: ({
    children,
    ...props
  }: HTMLAttributes<HTMLSpanElement> & { children: ReactNode }) => <span {...props}>{children}</span>,
}));
...
describe("HoldingsPage", () => {
  ...
  it("renders the private-assets tab and routes into the dedicated private-assets flow", async () => {
    ...
    expect(screen.getByText("Private assets stay separate from public holdings.")).toBeInTheDocument();
