...
impl PrivateAssetProjectionServiceTrait for PrivateAssetProjectionService {
    ...
    fn get_private_asset_detail(
        ...
        Ok(Some(PrivateAssetDetail {
            ...
            snapshots,
            freshness_state: derive_private_asset_freshness(latest_snapshot.as_ref(), self.today),
        }))
    }
...
mod tests {
    ...
    fn make_snapshot(
        ...
        value_source_type: PrivateSnapshotValueSourceType,
    ) -> PrivateSnapshot {
        PrivateSnapshot {
            id: id.to_string(),
    ...
    fn derives_freshness_states_from_latest_snapshot() {
        ...
        let current_snapshot = make_snapshot(
            ...
            dec!(0),
            PrivateSnapshotCashFlowType::TotalToDate,
            PrivateSnapshotValueSourceType::Manual,
        );
        ...
        let estimated_snapshot = make_snapshot(
            "snap-estimated",
            "asset-1",
            ...
            dec!(0),
            PrivateSnapshotCashFlowType::TotalToDate,
            PrivateSnapshotValueSourceType::Estimated,
        );
